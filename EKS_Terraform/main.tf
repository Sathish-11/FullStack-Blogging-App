...
resource "aws_eks_cluster" "abrahimcse" {
  ...
  depends_on = [
    aws_iam_role_policy_attachment.abrahimcse_cluster_role_policy
  ]
}
...
resource "aws_eks_node_group" "abrahimcse" {
  ...
  depends_on = [
    aws_iam_role_policy_attachment.abrahimcse_node_group_role_policy,
    aws_iam_role_policy_attachment.abrahimcse_node_group_cni_policy,
    aws_iam_role_policy_attachment.abrahimcse_node_group_registry_policy,
    aws_eks_cluster.abrahimcse
  ]
}
